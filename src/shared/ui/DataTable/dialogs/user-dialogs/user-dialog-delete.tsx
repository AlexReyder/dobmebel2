...
import { handleDeleteUser } from '@/shared/actions/auth'
...
interface Props {
	...
	currentRow: UserDbType
}

export function UserDialogDelete({ open, onOpenChange, currentRow }: Props) {
	const handleDelete = async () => {
		const {success, error} = await handleDeleteUser(currentRow.id)
		if(success){
